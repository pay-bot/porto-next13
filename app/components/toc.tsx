...
const useIntersectionObserver = (
  ...
  useEffect(() => {
    const callback = (headings: IntersectionObserverEntry[]) => {
      ...
      console.log(
        "🚀 ~ file: toc.tsx:31 ~ callback ~ headingElementsRef:",
        headingElementsRef
      );
      ...
      if (visibleHeadings.length === 1) {
        ...
        console.log(
          "🚀 ~ file: toc.tsx:52 ~ callback ~ sortedVisibleHeadings:",
...
const TableOfContents = ({ source }: TOCProps) => {
  ...
  console.log("🚀 ~ file: toc.tsx:82 ~ TableOfContents ~ activeId:", activeId);
